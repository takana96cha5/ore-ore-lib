...
ノード N の値を x とした時、先行ノードとは木の中に存在する x よりも小さい最大の値を持つノードのことを指します。
...
predecessor( toBinaryTree([-2,-17,8,-18,-11,3,19,null,null,null,-4,null,null,nul,25]), 8 )--> [3]
...
'''
二分探索木内の先行ノードの解説と解答
まずは findNode 関数を使って key のノードを探します。
ID199 二分探索木内探索の問題を参考に findNode 関数を定義しましょう。
